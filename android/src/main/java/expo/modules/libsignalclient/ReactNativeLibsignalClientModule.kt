...
//    }
    ...
    private fun groupSendEndorsementCombine(sendorseMents: List<String>): ByteArray {
        val rr = sendorseMents.map{ se -> Base64.decode(se, 0)}.map { se -> GroupSendEndorsement(se) }
